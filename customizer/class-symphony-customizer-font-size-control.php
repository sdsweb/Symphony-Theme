<?php
/**
 * Symphony Customizer Font Size Control
 *
 * Includes some backwards compatibility for WordPress 3.9
 */
...
final class Symphony_Customizer_Font_Size_Control extends WP_Customize_Control {
	/**
	 * @var string
	 */
